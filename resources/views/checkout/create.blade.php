                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="email" type="email" class="form-control {{ $errors->has('email') ? 'is-invalud' : '' }}" value="{{ Auth::user()->email }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="mb-4">
                                ...
                                <input name="discount" type="text" class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" value="{{old('discount')}}" placeholder="Enter your code">
